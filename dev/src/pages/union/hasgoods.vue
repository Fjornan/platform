...
<div class="p2222">
  <div class="p2020 m0020 bor-bottom pos-re">
    <el-breadcrumb separator="/">
      <el-breadcrumb-item :to="{ path: '/union/hasgoods' }">我有好货源</el-breadcrumb-item>
    </el-breadcrumb>
    <!-- <div class="bread-btn">
  ...
  <el-table :data="tableData" stripe style="width: 100%;text-align:left">
    ...
    <el-table-column prop="product" label="供应产品"></el-table-column>
...
export default {
  ...
  methods: {
    getData() {
      /* eslint-disable */
       this.$rqt.post('/union/getHasGoods', {
        status:this.status
       }).success((res) => {
    ...
    finishSubmit(id){
      this.$rqt.post('/union/finishHasGoods', {
        id:id
      }).success((res,xhr) => {
        if(res.error == 0){
          this.getData();
