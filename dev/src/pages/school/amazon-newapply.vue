...
<div class="p2222">
  <div class="p2020 m0020 bor-bottom pos-re">
    <el-breadcrumb separator="/">
      <el-breadcrumb-item :to="{ path: '/school/amanewapply' }">AMZ开店指导</el-breadcrumb-item>
    </el-breadcrumb>
    <!-- <div class="bread-btn">
...
export default {
  ...
  methods: {
    getData() {
      /* eslint-disable */
       this.$rqt.post('/school/getAmazonNewApply', {
        status:this.status
       }).success((res) => {
    ...
    finishSubmit(id){
      this.$rqt.post('/school/finishAmazonNewApply', {
        id:id
      }).success((res,xhr) => {
        if(res.error == 0){
          this.getData();
