    ...
    <el-form ref="form" :model="form" label-width="80px">
      <div style="width:500px">
        ...
        <el-form-item label="摘 要">
          <el-input type="textarea" :rows="4" v-model="form.digest"></el-input>
        </el-form-item>
      </div>
  ...
  export default {
    ...
    methods: {
      ...
      wangEditorInit(){
        ...
        // this.wangE.customConfig.uploadImgServer = this.$apiurl+'/up/up_pic2'
        // this.wangE.customConfig.uploadImgParams = {
        //     token: this.$auth.getData('token')   // 属性值会自动进行 encode ，此处无需 encode
        // }
        // this.wangE.customConfig.uploadFileName = 'Filedata'
        // this.wangE.customConfig.uploadImgHooks = {
        //   success: function (xhr, editor, result) {
        //       that.addImageToContent(result.key)
        //   },
        //   fail: function (xhr, editor, result) {
